# create rasters of fine fuels and ladder fuels for entire region
...
region <- sf::st_read("./Parameterization/Parameterization data/geomac_data/geomac_combined_2000-2023.gpkg") %>%
  sf::st_union()
...
fuel_lookup <- read.csv("./Parameterization/scrpple/fuel_loads_scott_burgan.csv") %>%
...
landfire_2001 <- raster("D:/Data/Landfire fuels/conus/US_105fbfm40_09122104/US_105fbfm40/grid1/us_105fbfm40") %>%
  raster::crop(region) %>%
  raster::mask(region)
landfire_fine_2001 <- raster::match(rast(landfire_2001), fuel_lookup$VALUE)
...
rm(landfire_2001)
writeRaster(landfire_fine_2001, "D:/Data/Landfire fuels/midwest/landfire_fine_2001.tif")
rm(landfire_fine_2001)
writeRaster(landfire_ladder_2001, "D:/Data/Landfire fuels/midwest/landfire_ladder_2001.tif")
...
rm(landfire_2012)
writeRaster(landfire_fine_2012, "D:/Data/Landfire fuels/midwest/landfire_fine_2012.tif")
rm(landfire_fine_2012)
writeRaster(landfire_ladder_2012, "D:/Data/Landfire fuels/midwest/landfire_ladder_2012.tif")
...
rm(landfire_2014)
writeRaster(landfire_fine_2014, "D:/Data/Landfire fuels/midwest/landfire_fine_2014.tif")
rm(landfire_fine_2014)
writeRaster(landfire_ladder_2014, "D:/Data/Landfire fuels/midwest/landfire_ladder_2014.tif")
...
rm(landfire_2019)
writeRaster(landfire_fine_2019, "D:/Data/Landfire fuels/midwest/landfire_fine_2019.tif")
rm(landfire_fine_2019)
writeRaster(landfire_ladder_2019, "D:/Data/Landfire fuels/midwest/landfire_ladder_2019.tif")
...
rm(landfire_2020)
writeRaster(landfire_fine_2020, "D:/Data/Landfire fuels/midwest/landfire_fine_2020.tif")
rm(landfire_fine_2020)
writeRaster(landfire_ladder_2020, "D:/Data/Landfire fuels/midwest/landfire_ladder_2020.tif")
...
rm(landfire_2021)
writeRaster(landfire_fine_2021, "D:/Data/Landfire fuels/midwest/landfire_fine_2021.tif")
rm(landfire_fine_2021)
writeRaster(landfire_ladder_2021, "D:/Data/Landfire fuels/midwest/landfire_ladder_2021.tif")
rm(landfire_ladder_2021)
gc()

# library("stars")
# library("raster")
# temp_rast <- raster("D:/Data/Landfire fuels/midwest/landfire_ladder_2001.tif") %>%
#   setValues(NA)
# landfire_fine_stack <- stack(replicate(21, temp_rast))
# landfire_fine_stack[[1]] <- raster("D:/Data/Landfire fuels/midwest/landfire_fine_2001.tif")
# landfire_fine_stack[[12]] <- raster("D:/Data/Landfire fuels/midwest/landfire_fine_2012.tif")
# landfire_fine_stack[[14]] <- raster("D:/Data/Landfire fuels/midwest/landfire_fine_2014.tif")
# landfire_fine_stack[[19]] <- raster("D:/Data/Landfire fuels/midwest/landfire_fine_2019.tif")
# landfire_fine_stack[[20]] <- raster("D:/Data/Landfire fuels/midwest/landfire_fine_2020.tif")
# landfire_fine_stack[[21]] <- raster("D:/Data/Landfire fuels/midwest/landfire_fine_2021.tif")
...
landfire_2001_fine <- read_stars("D:/Data/Landfire fuels/midwest/landfire_fine_2001.tif")
landfire_2001_ladder <- read_stars("D:/Data/Landfire fuels/midwest/landfire_ladder_2001.tif")
landfire_2012_fine <- read_stars("D:/Data/Landfire fuels/midwest/landfire_fine_2012.tif")
landfire_2012_ladder <- read_stars("D:/Data/Landfire fuels/midwest/landfire_ladder_2012.tif")
landfire_2014_fine <- read_stars("D:/Data/Landfire fuels/midwest/landfire_fine_2014.tif")
landfire_2014_ladder <- read_stars("D:/Data/Landfire fuels/midwest/landfire_ladder_2014.tif")
landfire_2019_fine <- read_stars("D:/Data/Landfire fuels/midwest/landfire_fine_2019.tif")
landfire_2019_ladder <- read_stars("D:/Data/Landfire fuels/midwest/landfire_ladder_2019.tif")
landfire_2020_fine <- read_stars("D:/Data/Landfire fuels/midwest/landfire_fine_2020.tif")
landfire_2020_ladder <- read_stars("D:/Data/Landfire fuels/midwest/landfire_ladder_2020.tif")
landfire_2021_fine <- read_stars("D:/Data/Landfire fuels/midwest/landfire_fine_2021.tif")
landfire_2021_ladder <- read_stars("D:/Data/Landfire fuels/midwest/landfire_ladder_2021.tif")
